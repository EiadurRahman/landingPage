        ...
        <div class="hero-slider-wrapper">
          <div class="item">
            <div class="item-image image-reveal" style="animation-delay: 2s;">
						{{ partial "image.html" (dict "Src" .image "Alt" "Image" "Class" "slider-image" ) }}
            </div>
            <div class="content">
              <h2>
                <span class="rev">
              ...
              {{ if .button.enable }}
              {{ with .button }}
              <a href="{{ .link | absURL }}" class="hero-btn btn page-scroll">{{.label}}</a>
              {{ end }}
              {{ end }}
            </div>
          </div>
...
<section class="mission" id="mission">
  <div class="bg">
    {{ partial "image.html" (dict "Src" `images/section-bg.jpg` "Alt" "section-bg" "Class" "img-fluid" ) }}
  </div>
  <div class="right-shape">
    {{ partial "image.html" (dict "Src" `images/right-shape.png` "Alt" "right-shape" "Class" "img-fluid" ) }}
  </div>
  <div class="container">
    <div class="row">
      <div class="col-12">
        ...
        <div class="mission-content">
          ...
          <div class="video image-reveal">
            <a class="video-play"
              ...
              {{ partial "image.html" (dict "Src" .video_thumb "Alt" "video-thumb" "Class" "img-fluid" ) }}
        ...
        <div class="visions">
          ...
          <div class="vision-item">
            <div class="image image-reveal">
              {{ partial "image.html" (dict "Src" .image "Alt" "vision-thumb" "Class" "img-fluid" ) }}
            </div>
...
<section class="products" id="products">
  <div class="bg">
    {{ partial "image.html" (dict "Src" `images/section-bg-2.jpg` "Alt" "section-bg" "Class" "img-fluid" ) }}
  </div>
  <div class="left-shape">
    {{ partial "image.html" (dict "Src" `images/left-shape.png` "Alt" "left-shape" "Class" "img-fluid" ) }}
  </div>
  <div class="container">
    <div class="row">
      <div class="col-12">
      ...
      <div class="col-lg-10 ml-auto p-0">
        <div class="product-slider-wrapper">
          ...
          <div class="product-item">
            {{ partial "image.html" (dict "Src" .image "Alt" "product-image" ) }}
            <div class="overlay">
              <div class="content">
  ...
  <div class="map-div">
    <div class="map-placeholder">
      <div class="map-placeholder-text">
        {{ .contact_text | markdownify }}
      </div>
    </div>
    <div class="office">
      <div class="contents">
        {{ partial "image.html" (dict "Src" .image "Alt" "office" ) }}
        <div class="address">
...
<footer class="footer">
	<div class="call-to-action text-center">
		...
		<a href="{{.button_link | absURL }}">{{.button_label}}</a>
	</div>
</footer>
{{end}}
{{end}}
...
<head>
  ...
  {{- else -}}
  {{- /* Helpful hint in the HTML if you misspell the file name later */ -}}
  {{- end -}}
  {{ else }}
  {{- /* Fallback block in case the config parameter is entirely empty */ -}}
  {{- $fallback := resources.Get "images/favicon.png" -}}
  {{- if $fallback -}}
  <link rel="shortcut icon" href="{{ $fallback.Permalink }}" type="image/x-icon">
  <link rel="icon" href="{{ $fallback.Permalink }}" type="image/x-icon">
  {{- end -}}
  {{ end }}
...
{{- if $src -}}
  {{- /* 1. Try to find the image inside the assets/ folder first */ -}}
  {{- $asset := resources.Get $src -}}
  
  {{- if $asset -}}
    <img src="{{ $asset.Permalink }}" alt="{{ $alt }}" class="{{ $class }}">
  {{- else -}}
    <img src="{{ $src | absURL }}" alt="{{ $alt }}" class="{{ $class }}">
  {{- end -}}
{{- end -}}
```

### themes/omega-hugo/assets/js/script.js
...
### themes/omega-hugo/assets/scss/_buttons.scss

```

```

### themes/omega-hugo/assets/scss/_common.scss
...
### themes/omega-hugo/assets/scss/_media-query.scss
...
### themes/omega-hugo/assets/scss/_typography.scss
...
### themes/omega-hugo/assets/scss/_variables.scss
...
### themes/omega-hugo/assets/scss/style.scss
...
### themes/omega-hugo/assets/scss/templates/_career.scss
...
### themes/omega-hugo/assets/scss/templates/_contact.scss
...
### themes/omega-hugo/assets/scss/templates/_footer.scss
...
### themes/omega-hugo/assets/scss/templates/_hero-area.scss
...
### themes/omega-hugo/assets/scss/templates/_mission.scss
...
### themes/omega-hugo/assets/scss/templates/_navigation.scss
...
### themes/omega-hugo/assets/scss/templates/_override.scss

```

```

### themes/omega-hugo/assets/scss/templates/_products.scss
...
### themes/omega-hugo/assets/scss/templates/_vision.scss
...
### themes/omega-hugo/assets/scss/vendors/_bootstrap.scss
...
### themes/omega-hugo/assets/scss/vendors/_fancybox.scss
...
### themes/omega-hugo/assets/scss/vendors/_font-awesome.scss
...
### themes/omega-hugo/assets/scss/vendors/_slick.scss
...
### themes/omega-hugo/layouts/404.html

```html

```

### themes/omega-hugo/layouts/index.html
...
### themes/omega-hugo/layouts/_default/baseof.html
...
### themes/omega-hugo/layouts/_default/career.html
		...
		<div class="row">
			<div class="col-md-12">
				<div class="block">
					...
					<div class="video image-reveal">
						<!-- Video Thumb -->
						{{ partial "image.html" (dict "Src" .video_thumb "Alt" "video-thumbnail" "Class" "img-fluid shadow" ) }}
						<!-- Video Button -->
...
<section class="gallery">
	<div class="container-fluid p-0">
		<div class="row no-gutters">
			{{ range .images }}
			<div class="col-md-4">
				{{ partial "process-image.html" (dict "Src" .) }}
				<div class="image image-reveal" data-fancybox="gallery" href="{{ . |absURL }}">
						{{ partial "image.html" (dict "Src" . "Alt" "Image" "Class" "img-fluid" ) }}
				</div>
			</div>
			{{ end }}
		</div>
				...
				<div class="block">
					...
					<div class="job">
						...
						<div class="apply-button">
							<a href="#" class="apply-btn" data-toggle="modal" data-target="#{{ .name | urlize }}">View
								Details</a>
							<!-- Modal -->
								...
								<div class="modal-dialog modal-lg">
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<!-- Application Form -->
											<form action="{{ .form_action | safeURL}}" method="post">
												<div class="row">
													<!-- Name -->
...
### themes/omega-hugo/layouts/_default/list.html
...
### themes/omega-hugo/layouts/_default/single.html
...
### themes/omega-hugo/layouts/partials/footer.html
...
### themes/omega-hugo/layouts/partials/head.html
...
### themes/omega-hugo/layouts/partials/header.html
        ...
        <nav class="navbar navbar-expand-lg">
          ...
          <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#main-nav"
            ...
            <span class="navbar-toggler-icon">
              {{ partial "image.html" (dict "Src" `images/hamburger-icon.png` "Alt" "menu" "Class" "img-fluid" ) }}
            </span>
          </button>
...
### themes/omega-hugo/layouts/partials/page-header.html
...
### themes/omega-hugo/layouts/partials/preloader.html
...
### themes/omega-hugo/layouts/partials/process-image.html
...
{{- if $image }}
  {{/* Process the image but don't render it - just access the RelPermalink to ensure processing */}}
  {{ $imageUrl := $image.RelPermalink }}
  {{/* Intentionally empty - no rendering of image */}}
{{- else }}
  {{/* Image not found but no rendering needed */}}
  <!-- Missing image: {{ $src }} -->
{{- end }}
```
